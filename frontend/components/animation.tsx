...
export default function Animation() {
  ...
  useEffect(() => {
    ...
    function initElements() {
      elementsRef.current = [];
      const numElements =
        Math.min(window.innerWidth, window.innerHeight) < 768 ? 25 : 40;
      ...
      for (let i = 0; i < numElements; i++) {
        ...
        const colors = [
          "rgba(255, 100, 0, 0.2)", // Laranja queimado (mais escuro)
          "rgba(220, 80, 0, 0.2)", // Vermelho alaranjado
          "rgba(180, 60, 0, 0.2)", // Laranja profundo
          "rgba(140, 40, 0, 0.2)", // Tom mais fechado
        ];

        const borderColors = [
          "rgba(255, 120, 0, 0.8)", // Laranja forte para bordas
          "rgba(230, 90, 0, 0.8)",
          "rgba(200, 70, 0, 0.8)",
          "rgba(170, 50, 0, 0.8)",
        ];
    ...
    const animate = () => {
      ...
      if (isDark) {
        gradient.addColorStop(0, "rgba(10, 10, 10, 1)"); // Quase preto
        gradient.addColorStop(1, "rgba(25, 25, 25, 1)"); // Cinza bem escuro// slate-800
      } else {
      ...
      for (const element of elementsRef.current) {
        ...
        if (element.y > canvas.height + element.height)
        ...
        switch (element.type) {
          ...
          case "toggle":
            ...
            const togglePos =
              Math.random() > 0.5
                ? element.x + element.width - element.height / 2
                : element.x + element.height / 2;
            context.arc(
              togglePos,
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center p-4">
        <div className="animation-content max-w-3xl">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent animation-gradient">
